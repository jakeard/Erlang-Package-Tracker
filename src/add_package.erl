...
-export([init/1, handle_call/3, handle_cast/2, handle_info/2,
         terminate/2, code_change/3, add/3, stop/0]).
...
add(Pid, Id, Info)->
        gen_server:call(Pid, {add_pack, Id, Info}).
...
%% @end
%%--------------------------------------------------------------------
handle_call({add_pack, B_Id, B_Info}, _From, Riak_Pid) ->
        Request = riakc_obj:new(<<"packages">>, B_Id, B_Info),
